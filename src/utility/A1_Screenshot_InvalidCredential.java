...
public class A1_Screenshot_InvalidCredential {
public static void main(String[] args) throws IOException {
		...
		driver.manage().window().maximize();//to maximize the window
		 ...
		 driver.findElement(By.xpath("(//input[@type='text'])[2]")).sendKeys("Admin");//Username
		
		 driver.findElement(By.name("txtPassword")).sendKeys("admin");//Password
		 
		driver.findElement(By.id("btnLogin")).click();//Submit
		
		//Specific condition for screenshot
