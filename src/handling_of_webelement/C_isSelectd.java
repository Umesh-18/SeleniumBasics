...
public class C_isSelectd {
	public static void main(String[] args) {
		...
		WebElement checkbox=driver.findElement(By.xpath("(//*[contains(@id, 'ohrmList_chkSelectRecord_')])[1]"));
		
     	boolean	isselected=checkbox.isSelected();
     	System.out.println("isSelected is:"+isselected);//false
     	
     	
     	checkbox.click();
     	boolean	isselect=checkbox.isSelected();
     	System.out.println("isSelect is:"+isselect);//true
